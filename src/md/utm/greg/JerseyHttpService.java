...
public class JerseyHttpService {
    ...
    public static void main(String[] args) throws IOException {
        ...
        ResourceConfig crunchifyResourceConfig = new PackagesResourceConfig("md.utm.greg");
    ...
    private static URI getCrunchifyURI() {
        return UriBuilder.fromUri("http://" + crunchifyGetHostName() + "/").port(8080).build();
    }
